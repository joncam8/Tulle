    ...
    <div id="wrapper">
        ...
        <section id="create_account">
            <div id="create_account">
                ...
                <form action="myaccount_success.html">
                    <div id="form_input">
                        <input type="type" placeholder="Email"  />
                        <input type="password" placeholder="Create User Id"  />
                        <input type="type" placeholder="Create password"  />
                        <input type="password" placeholder="Confirm Password"  />
                    </div>
                    <button type="submit" style="float: none;">Create Account</button>
                    
                    <p>Already have a account? <a href="login.php" class="login">Login</a></p>
                </form>
            </div>
        </section>
